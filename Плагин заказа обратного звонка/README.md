...
<p>2. Скопировать папку <code>ordercall</code> целиком в папку \wa-apps\shop\plugins.  </p>
<p>3. Перейти в папку <code>\wa-config\apps\shop</code>, открыть файл <code>plugins.php</code>, добавить строку:</p>
...
<p>6. Добавить хелпер <code>{shopOrdercallViewHelper::display()}</code> в шаблон вашей темы дизайна.</p>
