...
<p>1. Макет формы см. <a href="https://github.com/allicen/Webasyst/blob/master/img.png" target="_blank">по ссылке</a>. Форма должна быть адаптивной и корректно отображаться на мобильных устройствах.</p>
